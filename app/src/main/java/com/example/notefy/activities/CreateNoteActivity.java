package com.example.notefy.activities;
...
import com.example.notefy.database.NotesDatabase;
import com.example.notefy.entities.Note;
...
public class CreateNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageNotes = findViewById(R.id.imageNote);
            ...
            if (data != null){
                ...
                if (selectedImageUri != null){
                    try {
                        ...
                        imageNotes.setImageBitmap(bitmap);
